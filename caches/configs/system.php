...
'cookie_pre' => 'cweHe_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://www.psbcweb.org/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://www.psbcweb.org/statics/js/', //CDN JS
'css_path' => 'http://www.psbcweb.org/statics/css/', //CDN CSS
'img_path' => 'http://www.psbcweb.org/statics/images/', //CDN img
'app_path' => 'http://www.psbcweb.org/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'O099lkr2a0RTRvz5z2cc', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.psbcweb.org/phpsso_server',	//接口地址
'phpsso_auth_key' => 'iNoAeqx1qI5H9SIpckp7Xc0V9uZLFois', //加密密钥
